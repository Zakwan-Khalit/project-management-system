...
('kertask', 50000.00, 'Internal Development', 50000.00, '2025-01-01', '2025-06-30');
...
(1, 1, 'created', 'Project created', 'New project "kertask" has been created', 1, 0, NOW() - INTERVAL 5 DAY, NOW() - INTERVAL 5 DAY),
