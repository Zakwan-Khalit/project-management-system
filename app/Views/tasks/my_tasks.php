...
// Group tasks by status (use status_code if available, otherwise use status field)
$grouped_tasks = [];
foreach ($tasks as $task) {
    $taskStatus = getTaskStatus($task);
    $grouped_tasks[$taskStatus][] = $task;
}
?>

<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-user-tasks me-2"></i>My Tasks</h2>
    <div>
